...
var UTILITY_FOLDERS = ["about", "residents", "audition", "calendar", "resources", "art", "guestbook", "credits", "quiz", "quizsecret", "penny", "locations", "games", "merge", "crossroads", "guesswho", "uno", "boardwalk", "spotlight", "showdown"];
   ...
   this.innerHTML = `
    ...
    links.forEach(function (a) {
     ...
     // any character page also lights up the "Characters" tab
      ...
      if (key === "games" && ["merge", "crossroads", "guesswho", "uno", "boardwalk", "spotlight", "showdown"].indexOf(here) !== -1) {
        a.setAttribute("aria-current", "page");
      }
    });
  }
