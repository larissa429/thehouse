(function () {
  ...
  var TAGS = [
    ...
    'Liquid', 'Fizzy', 'Crunchy', 'Soft', 'Crumbly', 'Sticky', 'Frothy', 'Smooth', 'Juicy'
  ];
  ...
  var ALL_WORDS = [
    ...
    { name: 'Chili', tags: ['Spicy', 'Savory', 'Spice/Condiment', 'Crunchy', 'Juicy'] },
    { name: 'Walnut', tags: ['Nutty', 'Earthy', 'Crunchy'] },
    { name: 'Cream', tags: ['Creamy', 'Sweet', 'Rich', 'Smooth'] },
    { name: 'Charcoal', tags: ['Smoky', 'Bitter', 'Crumbly'] },
    { name: 'Sea Salt', tags: ['Salty', 'Savory', 'Spice/Condiment', 'Crunchy'] },
    { name: 'Ginger', tags: ['Spicy', 'Sweet', 'Spice/Condiment', 'Crunchy'] },
    { name: 'Mushroom', tags: ['Earthy', 'Savory', 'Food', 'Soft'] },
    { name: 'Grapefruit', tags: ['Sour', 'Bitter', 'Fruity', 'Juicy'] },
    ...
    { name: 'Coffee', tags: ['Earthy', 'Bitter', 'Drink', 'Rich', 'Liquid', 'Frothy'] },
    { name: 'Coconut', tags: ['Creamy', 'Sweet', 'Fruity', 'Rich', 'Crunchy', 'Soft'] },
    { name: 'Peppercorn', tags: ['Spicy', 'Earthy', 'Spice/Condiment', 'Crunchy'] },
    { name: 'Caramel', tags: ['Sweet', 'Bitter', 'Rich', 'Sticky', 'Smooth'] },
    { name: 'Anchovy', tags: ['Salty', 'Savory', 'Food', 'Soft'] },
    { name: 'Mint', tags: ['Floral', 'Bitter'] },
    { name: 'Truffle', tags: ['Earthy', 'Savory', 'Crumbly'] },
    { name: 'Berry', tags: ['Sweet', 'Sour', 'Fruity', 'Food', 'Juicy'] },
    { name: 'Smoked Paprika', tags: ['Smoky', 'Spicy', 'Food', 'Spice/Condiment'] },
    { name: 'Wine', tags: ['Fruity', 'Bitter', 'Drink', 'Rich', 'Liquid'] },
    { name: 'Tea', tags: ['Floral', 'Bitter', 'Drink', 'Liquid'] },
    { name: 'Lime', tags: ['Sour', 'Fruity', 'Juicy'] },
    { name: 'Honey', tags: ['Sweet', 'Floral', 'Rich', 'Sticky', 'Smooth'] },
    { name: 'Garlic', tags: ['Savory', 'Spicy', 'Spice/Condiment', 'Crunchy'] },
    { name: 'Onion', tags: ['Savory', 'Sour', 'Crunchy'] },
    { name: 'Blackberry', tags: ['Sour', 'Fruity', 'Food', 'Earthy', 'Juicy'] },
    { name: 'Clove', tags: ['Spicy', 'Earthy', 'Spice/Condiment', 'Crumbly'] },
    { name: 'Rosemary', tags: ['Earthy', 'Bitter', 'Spice/Condiment', 'Crunchy'] },
    { name: 'Molasses', tags: ['Sweet', 'Bitter', 'Smoky', 'Sticky'] },
    { name: 'Lavender', tags: ['Floral', 'Sweet', 'Crumbly'] },
    { name: 'Chocolate', tags: ['Sweet', 'Bitter', 'Rich', 'Food', 'Smooth'] },
    { name: 'Butter', tags: ['Creamy', 'Rich', 'Savory', 'Soft'] },
    { name: 'Yogurt', tags: ['Sour', 'Creamy', 'Food', 'Soft'] },
    { name: 'Cinnamon', tags: ['Spicy', 'Sweet', 'Rich', 'Crumbly'] },
    { name: 'Cardamom', tags: ['Spicy', 'Floral', 'Spice/Condiment', 'Crunchy'] },
    { name: 'Pineapple', tags: ['Sweet', 'Sour', 'Fruity', 'Food', 'Juicy', 'Sticky'] },
    { name: 'Beet', tags: ['Earthy', 'Sweet', 'Food', 'Juicy'] },
    { name: 'Kale', tags: ['Earthy', 'Bitter', 'Food', 'Crunchy'] },
    { name: 'Milk', tags: ['Creamy', 'Sweet', 'Drink', 'Liquid', 'Frothy'] },
    { name: 'Soda Water', tags: ['Sour', 'Drink', 'Liquid', 'Fizzy'] },
    { name: 'Whiskey', tags: ['Bitter', 'Smoky', 'Drink', 'Rich', 'Liquid'] },
    { name: 'Orange Zest', tags: ['Sour', 'Fruity', 'Spice/Condiment'] },
    { name: 'Turmeric', tags: ['Earthy', 'Bitter', 'Spice/Condiment'] },
    { name: 'Maple Syrup', tags: ['Sweet', 'Rich', 'Sticky', 'Liquid'] },
    { name: 'Olive', tags: ['Salty', 'Savory', 'Bitter', 'Food', 'Soft'] },
    { name: 'Curry Powder', tags: ['Spicy', 'Earthy', 'Spice/Condiment'] }
  ];

  var ALL_MENU = [
    { name: 'Lasagna', tags: ['Savory', 'Earthy', 'Creamy', 'Rich', 'Food', 'Soft'], desc: 'Layers of pasta, meat sauce, and melted cheese, baked until rich and bubbling.', img: 'lasagna.jpg' },
    { name: 'Steak and Eggs', tags: ['Savory', 'Salty', 'Rich', 'Food', 'Juicy'], desc: 'A savory seared steak served alongside eggs, cooked your way.', img: 'steakandeggs.jpg' },
    { name: 'Supreme Pizza', tags: ['Savory', 'Spicy', 'Salty', 'Food', 'Crunchy'], desc: 'Loaded with pepperoni, sausage, and peppers, with a spicy kick in every slice.', img: 'supremepizza.jpg' },
    { name: 'Buffalo Wings', tags: ['Spicy', 'Savory', 'Rich', 'Food', 'Crunchy', 'Sticky'], desc: 'Crispy wings tossed in a spicy buffalo sauce, served hot.', img: 'buffalowings.jpg' },
    { name: 'Caesar Salad', tags: ['Savory', 'Salty', 'Creamy', 'Food', 'Crunchy'], desc: 'Crisp romaine tossed in a creamy Caesar dressing with parmesan and croutons.', img: 'caesarsalad.jpg' },
    { name: 'Mushroom Risotto', tags: ['Earthy', 'Creamy', 'Savory', 'Rich', 'Food', 'Soft', 'Smooth'], desc: 'Slow-stirred rice with mushrooms, finished creamy and earthy.', img: 'mushroomrisotto.jpg' },
    { name: 'Chocolate Lava Cake', tags: ['Sweet', 'Bitter', 'Rich', 'Food', 'Smooth'], desc: 'A warm chocolate cake with a molten center — sweet, rich, and just a little bitter.', img: 'chocolatelava.jpg' },
    { name: 'Grilled Salmon', tags: ['Savory', 'Smoky', 'Rich', 'Food', 'Juicy'], desc: 'Grilled over an open flame for a smoky, rich finish.', img: 'grilledsalmon.jpg' },
    { name: 'Key Lime Pie', tags: ['Sour', 'Sweet', 'Fruity', 'Food', 'Crumbly', 'Smooth'], desc: 'A sour-sweet lime filling on a crumbling graham crust.', img: 'keylimepie.jpg' },
    { name: 'Old Fashioned', tags: ['Bitter', 'Sweet', 'Smoky', 'Drink', 'Liquid'], desc: 'Whiskey and sugar with a bitter dash of bitters, finished smoky from the char.', img: 'oldfashioned.jpg' },
    { name: 'Bloody Mary', tags: ['Savory', 'Spicy', 'Salty', 'Drink', 'Liquid'], desc: 'A savory tomato cocktail with a spicy, salty kick.', img: 'bloodymary.jpg' },
    { name: 'Mimosa', tags: ['Sour', 'Sweet', 'Fruity', 'Drink', 'Liquid', 'Fizzy'], desc: 'Sparkling wine and sweet orange juice, light and fruity.', img: 'mimosa.jpg' },
    { name: 'Irish Coffee', tags: ['Bitter', 'Sweet', 'Rich', 'Drink', 'Liquid', 'Frothy'], desc: 'Hot coffee with whiskey and cream, rich and just sweet enough.', img: 'irishcoffee.jpg' },
    { name: 'Piña Colada', tags: ['Sweet', 'Creamy', 'Fruity', 'Drink', 'Liquid', 'Smooth'], desc: 'A creamy, sweet blend of coconut and pineapple.', img: 'pinacolada.jpg' },
    { name: 'Whiskey Sour', tags: ['Sour', 'Sweet', 'Bitter', 'Drink', 'Liquid', 'Frothy'], desc: 'Whiskey shaken with lemon for a sharp, sour finish.', img: 'whiskeysour.jpg' },
    ...
    { name: 'Pesto Pasta', tags: ['Nutty', 'Earthy', 'Floral', 'Food', 'Smooth'], desc: 'Pasta tossed in a nutty, earthy basil pesto.', img: 'pestopasta.jpg' },
    { name: 'Blueberry Cobbler', tags: ['Sweet', 'Fruity', 'Rich', 'Food', 'Crumbly', 'Juicy'], desc: 'Warm, sweet blueberries under a golden, rich crust.', img: 'blueberrycobbler.jpg' },
    { name: 'Squid Ink Pasta', tags: ['Savory', 'Salty', 'Food', 'Smooth'], desc: 'A savory, salty pasta dyed black with squid ink.', img: 'squidinkpasta.jpg' },
    { name: 'Vanilla Milkshake', tags: ['Sweet', 'Creamy', 'Rich', 'Drink', 'Liquid', 'Smooth'], desc: 'A thick, creamy vanilla shake, sweet and rich.', img: 'vanillamilkshake.jpg' },
    { name: 'Mac and Cheese', tags: ['Savory', 'Creamy', 'Rich', 'Food', 'Soft'], desc: 'Pasta baked in a creamy, savory cheese sauce.', img: 'macandcheese.jpg' },
    { name: 'BBQ Ribs', tags: ['Smoky', 'Savory', 'Sweet', 'Food', 'Sticky', 'Juicy'], desc: 'Ribs slow-cooked over smoke, savory and sweet.', img: 'bbqribs.jpg' },
    { name: 'Fish Tacos', tags: ['Savory', 'Spicy', 'Sour', 'Food', 'Crunchy', 'Juicy'], desc: 'Crispy fish with a savory, spicy kick, finished with a sour squeeze of lime.', img: 'fishtacos.jpg' },
    { name: 'French Onion Soup', tags: ['Savory', 'Earthy', 'Rich', 'Food', 'Liquid'], desc: 'A rich onion broth, savory and earthy, topped with melted cheese and toast.', img: 'frenchonionsoup.jpg' },
    { name: 'Apple Pie', tags: ['Sweet', 'Fruity', 'Food', 'Crumbly', 'Juicy'], desc: 'Warm, sweet apples baked into a flaky, golden crust.', img: 'applepie.jpg' },
    { name: 'Shrimp Scampi', tags: ['Savory', 'Rich', 'Salty', 'Food', 'Juicy', 'Smooth'], desc: 'Garlic butter shrimp tossed with pasta, rich and salty.', img: 'shrimpscampi.jpg' },
    { name: 'Cobb Salad', tags: ['Savory', 'Rich', 'Salty', 'Food', 'Crunchy'], desc: 'Crisp greens topped with egg and bacon in a rich, savory dressing.', img: 'cobbsalad.jpg' },
    { name: 'Beef Stew', tags: ['Savory', 'Rich', 'Smoky', 'Food', 'Liquid'], desc: 'Slow-braised beef in a smoky, rich broth.', img: 'beefstew.jpg' },
    { name: 'Deviled Eggs', tags: ['Creamy', 'Savory', 'Food', 'Smooth'], desc: 'Creamy yolks whipped with a savory bite, served chilled.', img: 'deviledeggs.jpg' },
    { name: 'Peach Cobbler', tags: ['Sweet', 'Fruity', 'Food', 'Crumbly', 'Juicy', 'Soft'], desc: 'Warm, sweet peaches baked under a golden crust.', img: 'peachcobbler.jpg' },
    { name: 'Clam Chowder', tags: ['Creamy', 'Savory', 'Food', 'Liquid'], desc: 'A creamy, savory chowder loaded with tender clams.', img: 'clamchowder.jpg' },
    { name: 'Falafel Wrap', tags: ['Savory', 'Earthy', 'Food', 'Crunchy'], desc: 'Crispy chickpea falafel wrapped up with greens and a savory, earthy tahini drizzle.', img: 'falafelwrap.jpg' },
    ...
    { name: 'Egg Rolls', tags: ['Savory', 'Salty', 'Food', 'Crunchy'], desc: 'Golden fried rolls packed with a savory, salty filling.', img: 'eggrolls.jpg' },
    { name: 'Pumpkin Pie', tags: ['Sweet', 'Earthy', 'Food', 'Crumbly', 'Smooth'], desc: 'Warm spiced pumpkin custard, sweet and earthy, in a flaky crust.', img: 'pumpkinpie.jpg' },
    { name: 'Grilled Cheese', tags: ['Creamy', 'Rich', 'Savory', 'Food', 'Crunchy', 'Soft'], desc: 'Melted cheese between golden bread, rich, creamy, and savory.', img: 'grilledcheese.jpg' },
    { name: 'Margarita', tags: ['Sour', 'Sweet', 'Salty', 'Drink', 'Liquid'], desc: 'Tequila shaken with lime and a salty rim, sour and sweet.', img: 'margarita.jpg' },
    { name: 'Espresso Martini', tags: ['Bitter', 'Sweet', 'Rich', 'Drink', 'Liquid', 'Frothy', 'Smooth'], desc: 'Espresso and vodka shaken rich and bitter, just sweet enough.', img: 'espressomartini.jpg' },
    { name: 'Iced Tea', tags: ['Bitter', 'Sweet', 'Drink', 'Liquid'], desc: 'Cold-brewed tea, bitter and lightly sweetened.', img: 'icedtea.jpg' },
    { name: 'Strawberry Daiquiri', tags: ['Sour', 'Sweet', 'Fruity', 'Drink', 'Liquid', 'Smooth'], desc: 'Blended strawberries, sour and sweet, with a fruity finish.', img: 'strawberrydaiquiri.jpg' },
    { name: 'Hot Chocolate', tags: ['Sweet', 'Bitter', 'Creamy', 'Drink', 'Liquid', 'Frothy'], desc: 'Rich melted chocolate, sweet with a bitter edge, and creamy steamed milk.', img: 'hotchocolate.jpg' },
    { name: 'Ginger Beer', tags: ['Spicy', 'Sweet', 'Drink', 'Liquid', 'Fizzy'], desc: 'A spicy, sweet ginger brew with a sharp bite.', img: 'gingerbeer.jpg' },
    { name: 'Sparkling Lemonade', tags: ['Sour', 'Sweet', 'Drink', 'Liquid', 'Fizzy'], desc: 'Sparkling lemonade, sour and sweet with a fizzy lift.', img: 'sparklinglemonade.jpg' },
